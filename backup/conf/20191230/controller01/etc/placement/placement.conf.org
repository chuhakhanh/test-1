...
# DEPRECATED: The file that defines placement policies. This can be an absolute
# path or relative to the configuration file. (string value)
# This option is deprecated for removal since 2.0.0.
# Its value may be silently ignored in the future.
# Reason:
